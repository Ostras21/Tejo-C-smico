...
**Tejo Cósmico** es un videojuego desarrollado en **C++** con **Qt** como proyecto del curso de **Programación Orientada a Objetos (POO) 2026-1**. La obra mezcla el **tejo** , deporte nacional de Colombia, con un universo ciencia ficción ambientado en el sistema solar.
